; ------------------------------------------------------------------------------
; Project:  LED Shift Right
; File:     ledShiftRight.asm
; Author:   Leandro Schwarz
; Created:  2024-09-23
; Modified: 2024-10-03
; Version:  1.1
; Notes:    Creates an animation with LEDs. The LED moves to the right.
;               Fcpu = 16 MHz.
; ------------------------------------------------------------------------------
...
main:
    ...
    OUT     DDRD, auxReg                ; ...
    LDI     auxFrame, 0x80              ; Configures first frame
mainLoop:
    OUT     PORTD, auxFrame             ; Shows animation frame
    RCALL   delayMs250                  ; Waits frame delay
    LSR     auxFrame                    ; Performs right shift
    BRNE    mainLoop                    ; Continues animation if frame is valid
    LDI     auxFrame, 0x80              ; Configures first frame
    JMP     mainLoop
